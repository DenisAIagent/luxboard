  ...
  return (
    <div className={`rounded-lg border border-gray-200 bg-white ${className}`}>
      <div className="relative">
        <div className="h-32 w-full bg-gradient-to-r from-[#1a1a1a] to-gray-800" />
        <div className="absolute -bottom-16 left-6">
          <div className="relative">
            {user.avatar ? (
              ...
              <div className="flex h-32 w-32 items-center justify-center rounded-full border-4 border-white bg-gray-200 text-4xl font-bold text-gray-500">
                {user.name.charAt(0)}
              </div>
            )}
            {onEdit && (
      ...
      <div className="mt-20 px-6 pb-6">
        ...
        <div className="mt-6 space-y-4">
            ...
            {user.website && (
              <div>
                ...
                <a
                  ...
                  className="mt-1 text-sm text-[#1a1a1a] hover:underline"
                >
                  {user.website}
                </a>
              </div>
          ...
          {user.social && (
            <div>
              <h3 className="text-sm font-medium text-gray-900">Réseaux sociaux</h3>
